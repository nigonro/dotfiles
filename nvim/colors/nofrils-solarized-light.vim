...
let g:colors_name = "nofrils-solarized-light"
...
"    Baseline
hi   Normal             term=NONE        cterm=NONE        ctermfg=11      ctermbg=15      gui=NONE        guifg=#657b83   guibg=#fdf6e3

"    Faded
hi   ColorColumn        term=NONE        cterm=NONE        ctermfg=NONE    ctermbg=7       gui=NONE        guifg=NONE      guibg=#eee8d5
hi   Comment            term=NONE        cterm=NONE        ctermfg=14      ctermbg=NONE    gui=NONE        guifg=#93a1a1   guibg=NONE
...
hi   LineNr             term=NONE        cterm=NONE        ctermfg=11      ctermbg=7       gui=NONE        guifg=#93a1a1   guibg=#eee8d5
...
hi   SpecialComment     term=NONE        cterm=NONE        ctermfg=14      ctermbg=NONE    gui=NONE        guifg=#af8700   guibg=NONE
...
hi   VertSplit          term=NONE        cterm=NONE        ctermfg=fg      ctermbg=7       gui=NONE        guifg=#cb4b16   guibg=NONE
...
hi   CursorLineNr       term=NONE        cterm=bold        ctermfg=11      ctermbg=7       gui=NONE        guifg=NONE      guibg=#eee8d5
hi   CursorLine         term=NONE        cterm=NONE        ctermfg=NONE    ctermbg=7       gui=NONE        guifg=NONE      guibg=#eee8d5
hi   Cursor             term=NONE        cterm=NONE        ctermfg=fg      ctermbg=4       gui=NONE        guifg=fg        guibg=#00ffff
hi   Directory          term=NONE        cterm=NONE        ctermfg=53      ctermbg=NONE    gui=NONE        guifg=#d33682   guibg=NONE
hi   ErrorMsg           term=NONE        cterm=NONE        ctermfg=9       ctermbg=white   gui=bold        guifg=#ff5555   guibg=NONE 
hi   Error              term=NONE        cterm=NONE        ctermfg=9       ctermbg=white   gui=bold        guifg=#ff5555   guibg=NONE
hi   IncSearch          term=NONE        cterm=NONE        ctermfg=white   ctermbg=3       gui=NONE        guifg=white     guibg=#008000
hi   Search             term=NONE        cterm=NONE        ctermfg=white   ctermbg=3       gui=NONE        guifg=white     guibg=#008000
hi   MatchParen         term=NONE        cterm=bold        ctermfg=4       ctermbg=NONE    gui=NONE        guifg=#ffffff   guibg=#000080
hi   ModeMsg            term=NONE        cterm=NONE        ctermfg=5       ctermbg=NONE    gui=NONE        guifg=#5f005f   guibg=NONE
hi   MoreMsg            term=NONE        cterm=NONE        ctermfg=5       ctermbg=NONE    gui=NONE        guifg=#5f005f   guibg=NONE
hi   PmenuSel           term=NONE        cterm=NONE        ctermfg=2       ctermbg=15      gui=NONE        guifg=fg        guibg=#d33682
...
hi   Todo               term=NONE        cterm=NONE        ctermfg=5       ctermbg=NONE    gui=NONE        guifg=#008000   guibg=NONE
hi   WarningMsg         term=NONE        cterm=NONE        ctermfg=9       ctermbg=white   gui=NONE        guifg=#ff5555   guibg=white
hi   WildMenu           term=NONE        cterm=NONE        ctermbg=2       ctermfg=15      gui=NONE        guifg=#000000   guibg=white
hi   Visual             term=NONE        cterm=NONE        ctermfg=NONE    ctermbg=7       gui=NONE        guifg=NONE      guibg=#ffd787
...
hi   Keyword            term=NONE        cterm=NONE        ctermfg=10      ctermbg=NONE    gui=NONE        guifg=NONE      guibg=NONE
...
" 	hi Normal term=NONE cterm=NONE ctermfg=11 ctermbg=15 gui=NONE guifg=#000000 guibg=#fdf6e3
"     hi LineNr term=NONE cterm=NONE ctermfg=11 ctermbg=7 gui=NONE guifg=#af8700 guibg=NONE
"     hi Character term=NONE cterm=NONE ctermfg=NONE ctermbg=NONE gui=NONE guifg=NONE guibg=NONE
"     hi String term=NONE cterm=NONE ctermfg=NONE ctermbg=NONE gui=NONE guifg=NONE guibg=NONE
"
...
"     hi Comment term=NONE cterm=NONE ctermfg=14 ctermbg=NONE gui=NONE guifg=#af8700 guibg=NONE
" 	hi Normal term=NONE cterm=NONE ctermfg=11 ctermbg=15 gui=NONE guifg=#000000 guibg=#fdf6e3
"     hi LineNr term=NONE cterm=NONE ctermfg=11 ctermbg=7 gui=NONE guifg=#af8700 guibg=NONE
"     hi Character term=NONE cterm=NONE ctermfg=NONE ctermbg=NONE gui=NONE guifg=NONE guibg=NONE
"     hi String term=NONE cterm=NONE ctermfg=NONE ctermbg=NONE gui=NONE guifg=NONE guibg=NONE
...
" 		hi LineNr term=NONE cterm=NONE ctermfg=89 ctermbg=7 gui=NONE guifg=#87005f guibg=NONE
"     end
" endfunction
"
" " Command mappings
